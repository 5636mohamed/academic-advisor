...
[![EJUST edition](https://img.shields.io/badge/EJUST%20edition-v1.2.0-1a1a1a?logo=github&logoColor=white)](https://github.com/5636mohamed/ejust-academic-advisor)
...
> 🔱 **Forked as an EJUST edition.** A public, EJUST-branded fork of
> this repository — **[`ejust-academic-advisor`](https://github.com/5636mohamed/ejust-academic-advisor)
> (v1.2.0)** — exists for Egypt-Japan University of Science and
...
> Its core engine, catalog, and business rules track this repo closely —
> though as of v1.2.0 it's a cherry-pick, not a full sync: real backend
> authentication and the Curriculum Analytics epic are AEGIS-only so far
> — see that repo's own
> [`docs/COMPARISON.md`](https://github.com/5636mohamed/ejust-academic-advisor/blob/master/docs/COMPARISON.md)
> for exactly what does and doesn't differ.
...
![Transfer approval chain across student, advisor, and Vice President logins](docs/media/transfer-approval-chain-demo.gif)
...
| Light | Dark |
|---|---|
| ![Login page, light theme](docs/screenshots/login-light.png) | ![Login page, dark theme](docs/screenshots/login-dark.png) |
...
|---|---|
| ![Advisor transfer requests](docs/screenshots/advisor-transfer-requests.png) | ![Advisor responsibility confirmation modal](docs/screenshots/advisor-responsibility-modal.png) |

**Vice President portal**

| Dashboard | Advisor drill-down | Transfer requests |
|---|---|---|
| ![VP dashboard](docs/screenshots/vp-dashboard.png) | ![VP advisor drill-down](docs/screenshots/vp-advisor-detail.png) | ![VP transfer requests](docs/screenshots/vp-transfer-requests.png) |
