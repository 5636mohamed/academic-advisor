...
// and Vice President are separate parties who can't reach each other's
// pages." Not a UI convenience; these redirect away regardless of how the
// URL was reached (typed directly, bookmarked, etc.).
